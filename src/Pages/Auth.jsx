...
const Auth = () => {
    ...
    return (
        <div id='auth-container' className='relative flex justify-around items-center py-7 min-h-dvh sm:min-h-[80dvh] w-[100%] min-w-[370px] md:w-[80%] lg:w-[70%] lg:h-[70dvh] overflow-hidden mx-auto bg-gradient-to-br from-blue-700 to-teal-800 md:rounded-3xl'>
