...
const MyBlogs = () => {
    ...
    return (
        <>
            ...
            <div className={`fixed bg-opacity-60 hover:bg-opacity-80 backdrop-blur-lg ${(skip == 0 && noBlogs) ? 'rounded-full top-[53dvh] sm:top-[55dvh] sm:right-[43.5dvw] right-[38dvw]' : 'rounded top-[53dvh] sm:top-[48dvh] sm:right-10 right-2'} bg-blue-900 hover:bg-blue-700`} style={{ display: `${(skip > 0 && noBlogs) ? 'none' : 'block'}` }}>
